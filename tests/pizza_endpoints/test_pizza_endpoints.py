...
def test_delete_exists_pizza(test_db, name, price, ingredients):
    pizza = client.post("/pizza/create_pizza/", json={"name": name,
                                                         "price": price,
                                                         "ingredients": ingredients})
